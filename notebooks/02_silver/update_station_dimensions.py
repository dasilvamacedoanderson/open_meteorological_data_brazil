...
# Purpose: Strict Single-File Processor for Silver Layer Fact/Dim updates.
# ==============================================================================
...
# 2. Get EXACTLY ONE pending file from the Control Table Queue
...
# 3. Extract the single row (No 'for' loop needed!)
row = pending_files[0]
id_file = row["IDFILE"]
